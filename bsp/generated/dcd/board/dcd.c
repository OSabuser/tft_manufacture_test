...
const uint8_t dcd_data[] = {
	...
	/* #1.1-131, command header bytes for merged 'Write - value' command */
	0xCC, 0x04, 0x1C, 0x04,
	...
	/* #1.9, command: write_value, address: CCM_ANALOG_PFD_528, value: 0x230000, size: 4 */
	0x40, 0x0D, 0x81, 0x00, 0x00, 0x23, 0x00, 0x00,
	...
	/* #1.95, command: write_value, address: SEMC_MCR, value: 0x1000E000, size: 4 */
	0x40, 0x2F, 0x00, 0x00, 0x10, 0x00, 0xE0, 0x00,
	...
	/* #1.99, command: write_value, address: SEMC_BR1, value: 0x90000021, size: 4 */
	0x40, 0x2F, 0x00, 0x14, 0x90, 0x00, 0x00, 0x21,
	/* #1.100, command: write_value, address: SEMC_IOCR, value: 0x08, size: 4 */
	0x40, 0x2F, 0x00, 0x04, 0x00, 0x00, 0x00, 0x08,
	/* #1.101, command: write_value, address: SEMC_SDRAMCR0, value: 0xB27, size: 4 */
	0x40, 0x2F, 0x00, 0x40, 0x00, 0x00, 0x0B, 0x27,
	/* #1.102, command: write_value, address: SEMC_SDRAMCR1, value: 0x100100, size: 4 */
	0x40, 0x2F, 0x00, 0x44, 0x00, 0x10, 0x01, 0x00,
	/* #1.103, command: write_value, address: SEMC_SDRAMCR2, value: 0x20201, size: 4 */
	0x40, 0x2F, 0x00, 0x48, 0x00, 0x02, 0x02, 0x01,
	/* #1.104, command: write_value, address: SEMC_SDRAMCR3, value: 0x8193D0F, size: 4 */
	0x40, 0x2F, 0x00, 0x4C, 0x08, 0x19, 0x3D, 0x0F,
	/* #1.105, command: write_value, address: SEMC_DBICR0, value: 0x21, size: 4 */
	0x40, 0x2F, 0x00, 0x80, 0x00, 0x00, 0x00, 0x21,
	/* #1.106, command: write_value, address: SEMC_DBICR1, value: 0x888888, size: 4 */
	0x40, 0x2F, 0x00, 0x84, 0x00, 0x88, 0x88, 0x88,
	/* #1.107, command: write_value, address: SEMC_IPCR1, value: 0x02, size: 4 */
	0x40, 0x2F, 0x00, 0x94, 0x00, 0x00, 0x00, 0x02,
	/* #1.108, command: write_value, address: SEMC_IPCR2, value: 0x00, size: 4 */
	0x40, 0x2F, 0x00, 0x98, 0x00, 0x00, 0x00, 0x00,
	/* #1.109, command: write_value, address: SEMC_MCR, value: 0x10000004, size: 4 */
	0x40, 0x2F, 0x00, 0x00, 0x10, 0x00, 0x00, 0x04,
	/* #1.110, command: write_value, address: SEMC_BMCR0, value: 0x81, size: 4 */
	0x40, 0x2F, 0x00, 0x08, 0x00, 0x00, 0x00, 0x81,
	/* #1.111, command: write_value, address: SEMC_BMCR1, value: 0x81, size: 4 */
	0x40, 0x2F, 0x00, 0x0C, 0x00, 0x00, 0x00, 0x81,
	/* #1.112, command: write_value, address: SEMC_BR0, value: 0x8000001B, size: 4 */
	0x40, 0x2F, 0x00, 0x10, 0x80, 0x00, 0x00, 0x1B,
	/* #1.113, command: write_value, address: SEMC_BR1, value: 0x8200001B, size: 4 */
	0x40, 0x2F, 0x00, 0x14, 0x82, 0x00, 0x00, 0x1B,
	/* #1.114, command: write_value, address: SEMC_BR2, value: 0x8400001B, size: 4 */
	0x40, 0x2F, 0x00, 0x18, 0x84, 0x00, 0x00, 0x1B,
	/* #1.115, command: write_value, address: SEMC_BR3, value: 0x8600001B, size: 4 */
	0x40, 0x2F, 0x00, 0x1C, 0x86, 0x00, 0x00, 0x1B,
	/* #1.116, command: write_value, address: SEMC_BR4, value: 0x90000021, size: 4 */
	0x40, 0x2F, 0x00, 0x20, 0x90, 0x00, 0x00, 0x21,
	/* #1.117, command: write_value, address: SEMC_BR5, value: 0xA0000019, size: 4 */
	0x40, 0x2F, 0x00, 0x24, 0xA0, 0x00, 0x00, 0x19,
	/* #1.118, command: write_value, address: SEMC_BR6, value: 0xA8000017, size: 4 */
	0x40, 0x2F, 0x00, 0x28, 0xA8, 0x00, 0x00, 0x17,
	/* #1.119, command: write_value, address: SEMC_BR7, value: 0xA900001B, size: 4 */
	0x40, 0x2F, 0x00, 0x2C, 0xA9, 0x00, 0x00, 0x1B,
	/* #1.120, command: write_value, address: SEMC_BR8, value: 0x21, size: 4 */
	0x40, 0x2F, 0x00, 0x30, 0x00, 0x00, 0x00, 0x21,
	/* #1.121, command: write_value, address: SEMC_IOCR, value: 0x79A8, size: 4 */
	0x40, 0x2F, 0x00, 0x04, 0x00, 0x00, 0x79, 0xA8,
	/* #1.122, command: write_value, address: SEMC_SDRAMCR0, value: 0xF31, size: 4 */
	0x40, 0x2F, 0x00, 0x40, 0x00, 0x00, 0x0F, 0x31,
	/* #1.123, command: write_value, address: SEMC_SDRAMCR1, value: 0x652922, size: 4 */
	0x40, 0x2F, 0x00, 0x44, 0x00, 0x65, 0x29, 0x22,
	/* #1.124, command: write_value, address: SEMC_SDRAMCR2, value: 0x20201, size: 4 */
	0x40, 0x2F, 0x00, 0x48, 0x00, 0x02, 0x02, 0x01,
	/* #1.125, command: write_value, address: SEMC_SDRAMCR3, value: 0x8193D0F, size: 4 */
	0x40, 0x2F, 0x00, 0x4C, 0x08, 0x19, 0x3D, 0x0F,
	/* #1.126, command: write_value, address: SEMC_DBICR0, value: 0x21, size: 4 */
	0x40, 0x2F, 0x00, 0x80, 0x00, 0x00, 0x00, 0x21,
	/* #1.127, command: write_value, address: SEMC_DBICR1, value: 0x888888, size: 4 */
	0x40, 0x2F, 0x00, 0x84, 0x00, 0x88, 0x88, 0x88,
	/* #1.128, command: write_value, address: SEMC_IPCR1, value: 0x02, size: 4 */
	0x40, 0x2F, 0x00, 0x94, 0x00, 0x00, 0x00, 0x02,
	/* #1.129, command: write_value, address: SEMC_IPCR2, value: 0x00, size: 4 */
	0x40, 0x2F, 0x00, 0x98, 0x00, 0x00, 0x00, 0x00,
	/* #1.130, command: write_value, address: SEMC_IPCR0, value: 0x80000000, size: 4 */
	0x40, 0x2F, 0x00, 0x90, 0x80, 0x00, 0x00, 0x00,
	/* #1.131, command: write_value, address: SEMC_IPCMD, value: 0xA55A000F, size: 4 */
