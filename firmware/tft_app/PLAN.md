...
`settings_device_t.boot_screen_secs`, **пункта меню НЕТ** (решение
...
⚠️ Потянет **`SETTINGS_VERSION` 2 → 3**: на первом старте после прошивки
сохранённые настройки будут отброшены и применены дефолты. Ожидаемо, не баг.
