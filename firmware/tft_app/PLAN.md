...
**Осталось незакрытым:** кормление watchdog по-прежнему в единственном месте и в самой
низкоприоритетной задаче (`sul_rx_task`, `+1`). Прикрыто детектором (диагноз + управляемый
сброс), но не защищено. Правильный фикс — heartbeat-супервизор в демоне таймеров; меняет смысл
гарантии watchdog, ждёт решения.
