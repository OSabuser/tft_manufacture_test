...
| [BOOT_SCREEN.md](BOOT_SCREEN.md) | Загрузочный экран: состав строк и откуда что берётся, разделение компоновщик/рендер, механика показа через таймаут ожидания, потолок ширины, как добавить строку. |
...
[WATCHDOG.md](WATCHDOG.md)), загрузочный экран (Фаза 3.10, [BOOT_SCREEN.md](BOOT_SCREEN.md)). **Фаза 3 полностью закрыта документацией.** Ещё не реализовано
